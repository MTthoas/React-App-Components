...
import Button from './button_responsive_header';
...
const Nav = () => {
    ...
    let [openLoop, setOpenLoop] = useState(false);
  ...
  return (
    <div className='shadow-md w-full fixed top-0 left-0'>
      ...
      <div onClick={()=>setOpenLoop(!openLoop)} className='text-3xl absolute right-20 top-6 cursor-pointer md:hidden'>
